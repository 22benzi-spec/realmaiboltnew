        ...
        <template #bodyCell="{ column, record }">
          <template v-if="column.key === 'product'">
            <div class="product-cell">
              <img v-if="record.product_image" :src="record.product_image" class="product-img" />
              <div>
    ...
    >
      <template v-if="currentOrder">
        <a-descriptions :column="2" bordered size="small">
          <a-descriptions-item label="订单编号">{{ currentOrder.order_number }}</a-descriptions-item>
...
const columns = [
  { title: '订单号/产品', key: 'product', width: 220 },
...
.product-img { width: 40px; height: 40px; object-fit: cover; border-radius: 6px; border: 1px solid #f0f0f0; }
